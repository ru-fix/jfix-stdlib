...
public class IdGenerator {
    ...
    public IdGenerator(Byte serverId, AtomicInteger counter, Clock clock) {
        this.serverIdPart = (byte) (serverId & 0x7F);
    ...
    /**
     * Extract timestamp from key generate by {@link IdGenerator#nextVal()}
     *
     * @param generatedId -  id generated by {@link IdGenerator#nextVal()}
     * @return extracted timestamp from key
     */
